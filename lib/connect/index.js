...
exports.getWeatherData = exports.getCoords = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    settings = { method: 'Get' };
                    return [4 /*yield*/, nfetch(url, settings)
                            .then(function (res) { return res.json(); })
                            .then(function (json) {
                            if (json) {
                                var coords = json.results[0].locations[0].latLng;
